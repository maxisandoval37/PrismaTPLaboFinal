...
from .views import ListadoCliente, RegistrarCliente, EditarCliente, RegistrarMDP, CambiarEstadoCuentaCorriente,RegistrarCuentaCorriente, ListadoCuentasCorriente, EliminarCuentaCorriente, verRegistro, consultaDiaria, consultaHistorico, DesactivarCliente
...
urlpatterns = [
    ...
    path('editar_cliente/<int:pk>/', login_required(DesactivarCliente.as_view()), name = 'editar_cliente'),
