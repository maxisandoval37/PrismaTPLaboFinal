    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_de_barras', models.BigIntegerField(default=4205443935373, unique=True, verbose_name='Código de barras')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigo_de_barras', models.BigIntegerField(default=6229513328756, unique=True, verbose_name='Código de barras')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigo_de_barras', models.BigIntegerField(default=4815583604802, unique=True, verbose_name='Código de barras')),
                ('nombre', models.CharField(max_length=30, verbose_name='Nombre de pintura')),
                ('color', models.CharField(max_length=50, verbose_name='Color de pintura')),
                ('cantidad', models.PositiveIntegerField(verbose_name='Cantidad de pintura')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solicitado', models.IntegerField(default=39, verbose_name='Solicitado ')),
                ('cuenta_corriente', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='proveedor.cuentacorrienteproveedor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primera_pintura', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='item.pintura')),
                ('segunda_pintura', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='item.pintura')),
            ],
            options={
                'verbose_name': 'mezcla',
