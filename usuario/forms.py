...
from .models import Supervisor, Usuario, Vendedor, Cajero, Administrativo, GerenteGeneral
...
class FormularioAdministrativo(forms.ModelForm):
    """ Formulario de Registro de un Administrativo en la base de datos
    Variables:
        - password1:    Contraseña
        - password2:    Verificación de la contraseña
    """
...
class FormularioGerenteGeneral(forms.ModelForm):
