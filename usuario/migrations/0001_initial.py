    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, max_length=16, null=True, verbose_name='Nombre')),
                ('apellido', models.CharField(blank=True, max_length=16, null=True, verbose_name='Apellido')),
                ...
                ('cod_postal', models.IntegerField(blank=True, null=True, verbose_name='Código postal')),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('estado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='usuario.estado')),
