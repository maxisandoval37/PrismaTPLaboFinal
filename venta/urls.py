...
from .views import ListadoVenta, RegistrarVentaLocal, EditarVentaLocal, eliminarItemCajero, EliminarVenta, ListarItem, VerDetalle, AgregarItem, CambiarEstado, eliminarItem,ListadoVentaCajero, FinalizarVenta, VerItems
...
urlpatterns = [
    ...
    path('ingresar_monto/<int:pk>/', login_required(EditarVentaLocal.as_view()), name= 'ingresar_monto'),
    ...
    path('listado_ventas/<int:id>/<int:cliente>/', login_required(CambiarEstado), name= 'cambiar_estado'),
    path('eliminar_item/<int:venta>/<int:item>/', login_required(eliminarItem), name = 'eliminar_item'),
    path('eliminar_item_cajero/<int:venta>/<int:item>/', login_required(eliminarItemCajero), name = 'eliminar_item_cajero'),
