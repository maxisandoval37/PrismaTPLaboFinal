    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opciones', models.CharField(choices=[('CANCELADA POR EL CLIENTE', 'Cancelada Por Cliente'), ('CANCELADA POR LA SUCURSAL', 'Cancelada Por Sucursal'), ('PENDIENTE DE RETIRO', 'Pendiente De Retiro'), ('EN PREPARACIÓN', 'En Preparacion'), ('LISTA', 'Lista'), ('PAGADA', 'Pagada'), ('RETIRADA', 'Retirada'), ('RECHAZADA', 'Rechazada'), ('NO RETIRADA', 'No Retirado')], max_length=25)),
            ],
        ),
        migrations.CreateModel(
            name='Venta',
